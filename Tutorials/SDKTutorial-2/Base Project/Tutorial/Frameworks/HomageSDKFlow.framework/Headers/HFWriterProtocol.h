 ...
 *  Classes implementing this protocol implement saving a series of frames/images/image data in buffers
 *  to some file format (to what file format type - video, gif, png sequence etc, is up to the specific implementation)
 */
 ...
 *  @param timeStamp  long long the time stamp related to this frame.
